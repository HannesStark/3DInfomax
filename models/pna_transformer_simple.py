...
class PNATransformerSimple(nn.Module):
    ...
    def __init__(self, node_dim, hidden_dim, target_dim, dropout, nhead, dim_feedforward, aggregators: List[str],
        ...
        super(PNATransformerSimple, self).__init__()
        self.node_gnn = PNATransformerGNNSimple(node_dim=node_dim, hidden_dim=hidden_dim, dim_feedforward=dim_feedforward,
...
class PNATransformerGNNSimple(nn.Module):
    def __init__(self, node_dim, hidden_dim, dim_feedforward, aggregators: List[str], scalers: List[str],
                 ...
                 **kwargs):
        super(PNATransformerGNNSimple, self).__init__()
