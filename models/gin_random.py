...
class GNN_nodeRandom(nn.Module):
    ...
    """
    def __init__(self, num_layers, hidden_dim, dropout = 0.5, JK = "last", residual = False, gnn_type = 'gin', random_vec_dim=10):
        '''
...
class GNN_node_VirtualnodeRandom(nn.Module):
    ...
    Output:
        node representations
    """
    def __init__(self, num_layers, hidden_dim, dropout = 0.5, JK = "last", residual = False, gnn_type = 'gin', pretrain_mode=False, random_vec_dim=10, n_model_confs = 10):
        '''
            num_layers (int): number of GNN message passing layers
            hidden_dim (int): node embedding dimensionality
        '''
